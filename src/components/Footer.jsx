...
const Footer = () => (
    <footer>
        <div className="marks">
            ...
            <span className="product-name">Unfx proxy parser</span>
        ...
        <div className="socials">
            ...
            <a title="Github Page">
                <svg xlinkHref="https://github.com/assnctr/unfx-proxy-parser" onClick={openLink} className="github-svg" x="0px" y="0px" viewBox="0 0 90 90">
